...
<!-- docref: end -->
<!-- docref: begin src=server/internal/pki/lifecycle_guard_test.go#TestGuard_PkiLifecycleHandlersUseDeviceLock:956a37fb,server/internal/pki/lifecycle_guard_test.go#TestLifecycleLockGuard_FixtureDetected:5b070e4b,server/guards_test.go#TestGuard_ProjectionWritesOnlyFromProjectors:74f34204 -->
