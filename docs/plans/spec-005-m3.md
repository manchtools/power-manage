...
<!-- docref: begin src=server/internal/store/store.go#RebuildTarget:1cd7119a,server/internal/store/store.go#New:ff592594,server/internal/store/rebuild.go#RebuildAll:c3817b76,server/internal/store/generated/events.sql.go#ListEventsForReplayPage:b8ed1a35,server/internal/store/generated/events.sql.go#RebuildTableClosure:afc91dce -->
