...
<!-- docref: end -->
<!-- docref: begin src=server/internal/store/migrations/004_execution_outputs.sql#@execution-output-schema:2f07a118,server/internal/store/telemetry.go#NewTelemetryStore:7bf5e1f7,server/internal/store/telemetry.go#AppendExecutionOutput:741ccb18,server/internal/store/telemetry.go#ReadExecutionOutput:2aa76b16 -->
