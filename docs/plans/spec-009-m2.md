...
<!-- docref: begin src=server/internal/control/device_groups.go#managementDomains:178b7675,server/internal/control/boundary_generator_test.go#generateCRUDBoundaryCases:b77169a1,server/internal/control/rpc_guards_test.go#TestGuard_ControlRPCsHaveExactlyOneImplementationClass:d2762cfc,server/internal/control/rpc_guards_test.go#TestGuard_ControlAuthorizationMatchesImplementationClass:e31852d8,server/request_context_guard_test.go#TestGuard_RequestPathsDoNotCreateBackgroundContexts:0cdf60f3,server/request_context_guard_test.go#TestGuard_DetachedContextsAreBoundedAndAllowlisted:b2de0f54,server/internal/pki/rotation.go#NewRotationManager:41995439 -->
