...
<!-- docref: begin src=server/internal/auth/tokens.go#Claims:a24686e6,server/internal/auth/tokens.go#Signer:8e8b587e,server/internal/auth/tokens.go#Verifier:cf5fcba2,server/internal/auth/tokens.go#GenerateSigningKey:0e6ca735,server/internal/auth/tokens.go#NewSigner:8be3d7cd,server/internal/auth/tokens.go#NewVerifier:ef4febae,server/internal/auth/tokens.go#Signer.MintAccess:cb0d83d6,server/internal/auth/tokens.go#Signer.MintRefresh:356e5713,server/internal/auth/tokens.go#Verifier.VerifyAccess:b8900acd,server/internal/auth/tokens.go#Verifier.VerifyRefresh:20bd79c0,server/internal/auth/tokens.go#ErrExpired:cb97e288,server/internal/auth/tokens.go#ErrInvalid:cb97e288,contract/archtest/descwalk.go#allMessages:98b321b1,contract/archtest/descwalk.go#localCredentialFieldViolations:6e5cf3cd,contract/archtest/domainscan.go#approvedRawSignatureSites:85618e10,contract/archtest/guards_test.go#TestGuard_SignatureDomains:f8bc1b90 -->
...
<!-- docref: begin src=server/internal/auth/tokens_test.go#TestTokenService_MintsAndVerifiesPinnedTypesAndLifetimes:24432efd,server/internal/auth/tokens_test.go#TestTokenService_RejectsNonES256AlgorithmsIncludingPublicKeyHMAC:f76c2172,server/internal/auth/tokens_test.go#TestTokenService_ExposesOnlyExpiryAsDistinct:7ff8809c,server/internal/auth/tokens_test.go#TestTokenService_RejectsCrossTypeUse:02c6dab6,server/internal/auth/tokens_test.go#TestTokenService_RejectsInvalidConstructionAndClaims:bc66806d,contract/archtest/auth_test.go#TestGuard_NoLocalCredentialSurface:d71da4ac,contract/archtest/auth_test.go#TestGuard_NoLocalCredentialSurface_Liveness:15183b00 -->
