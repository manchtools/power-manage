...
<!-- docref: begin src=sdk/nilcheck/nilcheck_test.go#TestInterface:edd47699,server/internal/auth/interceptors_test.go#TestGuard_RPCClassificationCoversEveryProcedure:c43e38a4,server/internal/auth/interceptors_test.go#TestProcedureClassifications_DefensivelyCopied:535d8c5b,server/internal/auth/interceptors_test.go#TestInterceptorChain_EnforcesOrder:5923bc0f,server/internal/auth/interceptors_test.go#TestNewInterceptorChain_RejectsMissingStages:29ce8f6c,server/internal/auth/interceptors_test.go#TestInterceptorChain_ShortCircuitsInOrder:fbf5f0d9,server/internal/auth/interceptors_test.go#TestInterceptorChain_EnforcesStreamingHandlerOrder:158e9faf,server/internal/auth/interceptors_test.go#TestInterceptorChain_ShortCircuitsStreamingHandlerInOrder:c794284a,server/internal/auth/interceptors_test.go#TestInterceptorChain_InvalidStreamingClientFailsClosed:1d727ddf,server/internal/control/handler_test.go#TestNewHTTPHandler_RejectsMissingDependencies:8c3b97d4,server/internal/control/auth_guard_test.go#TestGuard_ControlHandlersUseNoCookies:384264da,server/internal/control/auth_guard_test.go#TestGuard_ControlHandlersUseNoCookies_Liveness:436101a2 -->
- `TestInterface`
